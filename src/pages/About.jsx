    ...
    <h1>About Us</h1>
     ...
     <div className='aboutContent'>
       <div className='aboutArticle'>
         ...
         <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus, ab? Pariatur debitis molestiae neque! Iure, odio voluptatum, natus eius nisi architecto in dolores illum distinctio harum ratione! Eligendi libero praesentium sequi voluptatibus, animi corporis magni accusantium dolor maiores eum quo. Suscipit veniam adipisci iure pariatur quia inventore atque doloremque consequatur?</p>  
       </div>
       <div className='aboutImage'>
         <img className='samuel' src={samuel} alt="" />
       </div>
