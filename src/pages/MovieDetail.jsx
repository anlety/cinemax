...
function MovieDetail() {
  ...
  return (
    ...
    <div className='movie-info'   >
       ...
       <div className="backgroundImage"  style={{ backgroundImage: `url(https://image.tmdb.org/t/p/w500${aMovie?.poster_path})`, backgroundSize: "cover", backgroundRepeat: "no-repeat" }}>
